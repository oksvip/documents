> 此文件是 [项目文档编写规范](https://fsdhub.com/books/laravel-specification/524/project-documentation-specification) 的 readme 编写范例，点击 [我要改进](https://fsdhub.com/articles/523/patches/create) 即可查看其 Markdown 内容。
